<template>
    <div>
        <el-card>
            ...
            >清空</el-button>
            <!-- 查询列表区域 -->
            <el-table :data="smsQueryList" border stripe>
                ...
                <el-table-column label="短信号" prop="smsCode" align="center" show-overflow-tooltip></el-table-column>
                <el-table-column
                    label="模板名称"
                    prop="templateName"
                    align="center"
                ...
                ></el-table-column>
                <el-table-column label="分公司" prop="companyId" align="center"></el-table-column>
                <el-table-column label="接收者" prop="receiver" align="center"></el-table-column>
                <el-table-column label="手机号码" prop="phoneNum" align="center" show-overflow-tooltip></el-table-column>
        ...
        <!-- 查看弹出框 -->
        <el-dialog title="查看短信" :visible.sync="viewVisible" class="diaForm" width="50%">
            <div class="dialogDiv">
                <el-form ref="form" :model="form" label-width="80px">
                    ...
                    <el-form-item label="来源">
                        <el-input v-model="form.originDesc" disabled></el-input>
                    </el-form-item>
                    <el-form-item label="短信号">
                        <el-input v-model="form.smsCode" disabled></el-input>
                    </el-form-item>
                    <el-form-item label="模板名称">
                        <el-input v-model="form.templateName" class="handle-input" disabled></el-input>
                    </el-form-item>
                    <el-form-item label="接收者">
                        <el-input v-model="form.receiver" class="handle-input" disabled></el-input>
                    </el-form-item>
                    <el-form-item label="手机号码">
                        <el-input v-model="form.phoneNum" class="handle-input" disabled></el-input>
                    </el-form-item>
                    <el-form-item label="发送时间">
                        <el-input v-model="form.sendTime" class="handle-input" disabled></el-input>
                    </el-form-item>
                    <el-form-item label="状态">
                        <el-input v-model="form.statusDesc" class="handle-input" disabled></el-input>
                    </el-form-item>
                    <el-form-item label="短信内容">
                        <el-input type="textarea" rows="5" v-model="form.smsDetail" disabled></el-input>
                    </el-form-item>
                </el-form>
            </div>
...
export default {
    ...
    methods: {
        ...
        // 搜索短信
        async searchSmsQuery() {
            const { data: res } = await this.$http.post('/smsInfo/list', this.queryForm);
            // console.log(res);
            if (res.code !== '0000') {
                return this.$message('获取用户列表失败');
            } else {
                this.smsQueryList = res.data;
        ...
        async getTemplateList() {
            const { data: res } = await this.$http.post('/templateService/getTemplate', this.query);
            if (res.code !== '0000') {
        ...
        async handleView(scope, row) {
            const { data: res } = this.$http.post('/smsInfo/info/' + row.id);
